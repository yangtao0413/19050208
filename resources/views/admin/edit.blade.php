...
<body>
	...
	<!-- @if ($errors->any())
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-10">
	      <input type="text" name="name" value="{{$data->name}}" class="form-control" id="firstname" placeholder="请输入管理员姓名">
...
<!-- 	  <div class="form-group">
	    ...
	    <div class="col-sm-10">
	      <input type="password" name="repwd" value="{{$data->repwd}}" class="form-control" id="lastname" placeholder="请确认密码">
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-10">
	      <input type="text" name="tel" value="{{$data->tel}}" class="form-control" id="lastname" placeholder="请输入电话">
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-10">
	      <input type="text" name="email" value="{{$data->email}}" class="form-control" id="lastname" placeholder="请输入邮箱">
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-10">
	    <img src="{{env('UPLOAD_URL')}}{{$data->head}}" width="100">
	  ...
	  <label for="lastname" class="col-sm-2 control-label">性别</label>
	    <div class="col-sm-offset-2 col-sm-10">
	      <div class="checkbox">
	        <label>
	          <input type="radio" name="sex" value="1" @if($data->sex==1) checked="checked" @endif>男  <input type="radio" name="sex" value="0" @if($data->sex==0) checked="checked" @endif>女
	        </label>
	      </div>
	    </div>
	  </div>
