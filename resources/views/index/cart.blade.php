...
<html lang="zh-cn">
  <head>
    ...
    <title>三级分销</title>
    <link rel="shortcut icon" href="/img/index/images/favicon.ico" />
  ...
  <body>
    <div class="maincont">
     ...
     <div class="dingdanlist" onClick="window.location.href='address.html'">
      <table>
       <tr>
        <td class="dingimg" width="75%" colspan="2"><a href="{{url('/address/index')}}">新增收货地址</a></td>
    ...
    @foreach($cartinfo as $v)
       ...
       <tr>
        <th colspan="3"><strong class="orange">¥123</th>
       </tr>
    @endforeach
       <tr>
    ...
    <div class="gwcpiao">
     <table>
      <tr>
       ...
       <td width="40%"><a href="{{url('/success/index')}}" class="jiesuan">提交订单</a></td>
      </tr>
     </table>
    </div><!--gwcpiao/-->
    </div><!--maincont-->
